...
<body class="font-sans antialiased">
    ...
    document.documentElement.classList.toggle('dark', darkMode);" class="min-h-screen bg-gray-100 dark:bg-gray-900">
                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        <button @click="darkMode = !darkMode"
                            class="p-2 rounded-full text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none">
                        ...
                        @auth
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    ...
                                    <button
                                        ...
                                        <div class="ms-1"><svg class="fill-current h-4 w-4"
                                                xmlns="http://www.w.org/2000/svg" viewBox="0 0 20 20">
                                ...
                                <x-slot name="content">
                                    ...
                                    @can('crear-usuarios')
                                        <x-dropdown-link :href="route('usuarios.index')" :active="request()->routeIs('users.*')">
                        ...
                        @else
                            <a href="{{ route('login') }}"
                                class="ms-4 font-semibold text-gray-600 dark:text-gray-400 hover:text-white dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
